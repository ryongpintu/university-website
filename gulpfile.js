...
gulp.task('styles', function() {
  return gulp.src('./wp-content/themes/University/css/style.css')
    .pipe(postcss([cssImport, mixins, cssvars, nested, rgba, colorFunctions, autoprefixer]))
    .on('error', (error) => console.log(error.toString()))
    .pipe(gulp.dest('./wp-content/themes/University/'));
});
...
gulp.task('watch', function() {
  ...
  gulp.watch('./wp-content/themes/University/css/**/*.css',function(){
       console.log('i m woking css');
