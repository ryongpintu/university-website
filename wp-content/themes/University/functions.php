...
function university_files(){
	wp_enqueue_script('googleMap', '//maps.googleapis.com/maps/api/js?key=AIzaSyBw1GdP9L1rleHtMW5vNjMTc-sFTIgYgOU',NULL,'1.0',true);
...
function universityMapKey($api){
	...
	$api['key']='AIzaSyBw1GdP9L1rleHtMW5vNjMTc-sFTIgYgOU';
	return $api;
...
// Removing the admin bar from the user site
...
// loading the style css and font awesome in the backend 
...
// Getting Hovering effect on login page
